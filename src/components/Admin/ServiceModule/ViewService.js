...
const ViewService = () => {
    ...
    const loading = services === undefined || services.length === 0;
            ...
            <table className="table-auto w-full bg-white border border-gray-200">
                <thead className="bg-white border-b sticky top-0 z-10">
                    <tr>
                        ...
                        <th className="text-sm font-medium text-gray-900 p-3 text-left w-40">Category</th>
                    ...
                    {loading ? (
                        ...
                        services.map((service, index) => (
                            <tr key={service._id} className="border-b hover:bg-gray-50">
                                ...
                                <td className="p-3 text-sm text-gray-700 truncate">{service.name}</td>
                                <td className="p-3 text-sm text-gray-700">{service.category}</td>
