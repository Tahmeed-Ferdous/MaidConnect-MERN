            ...
            <table className="table-auto w-full bg-white border border-gray-200">
                <thead className="bg-white border-b sticky top-0 z-10">
                    <tr>
                        ...
                        <th className="text-sm font-medium text-gray-900 p-3 text-left w-60">Email</th>
                        <th className="text-sm font-medium text-gray-900 p-3 text-left w-32">Role</th>
                    ...
                    {loading ? (
                        ...
                        users.map((user, index) => (
                            <tr key={user._id} className="border-b hover:bg-gray-50">
                                ...
                                <td className="p-3 text-sm text-gray-700 truncate">{user.name}</td>
                                <td className="p-3 text-sm text-gray-700 truncate break-all">{user.email}</td>
